...
public class SlidingTabLayout extends HorizontalScrollView {
    public void setLocalPageListener(ViewPager.OnPageChangeListener localPageListener) {
        this.localPageListener = localPageListener;
    }
    ...
    private class InternalViewPagerListener implements ViewPager.OnPageChangeListener {
        ...
        public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
            adjustTabMenu(position, positionOffset, positionOffsetPixels);
            if (localPageListener != null) {
                localPageListener.onPageScrolled(position, positionOffset, positionOffsetPixels);
            }
        }
        ...
        public void onPageScrollStateChanged(int state) {
            ...
            if (localPageListener != null) {
                localPageListener.onPageScrollStateChanged(state);
            }
        }
        ...
        public void onPageSelected(int position) {
            ...
            if (localPageListener != null) {
                localPageListener.onPageSelected(position);
            }
        }

    }

    private void adjustTabMenu(int position, float positionOffset, int positionOffsetPixels) {
    ...
    public void setCurrentItem(int position){
        adjustTabMenu(position, 0.01f, 10);
    }
